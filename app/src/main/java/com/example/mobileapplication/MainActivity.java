...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.cos).setOnClickListener((view)->onOperationClick("cos"));
        findViewById(R.id.sin).setOnClickListener((view)->onOperationClick("sin"));
        findViewById(R.id.sqrt).setOnClickListener((view)->onOperationClick("sqrt"));
        findViewById(R.id.exp).setOnClickListener((view)->onOperationClick("exp"));
